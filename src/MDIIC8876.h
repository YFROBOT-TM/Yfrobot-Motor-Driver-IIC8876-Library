...
public:
    ...
    void setMotorSpeed(int pinA, int pinB, int speed);                  // 驱动单路电机
    void setMotor(int m1Speed, int m2Speed, int m3Speed, int m4Speed);  // 驱动4路电机
    void setMotor(int motorId, int speed);                              // 驱动单路或者全部4路电机
    void stopMotor(int motorId);                                        // 停止电机（单路或者全部）
